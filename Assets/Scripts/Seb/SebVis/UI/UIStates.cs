...
namespace Seb.Vis.UI
{
	...
	{
		public InputFieldState.TriggerState arrowKeyTrigger;
		public InputFieldState.TriggerState backspaceTrigger;
		public InputFieldState.TriggerState deleteTrigger;
		public float scrollY;
		public int cursorBeforeCharIndex;
		public bool isMouseDownInBounds;
		public bool isSelecting;
		...
		public bool focused { get; private set; }
		public float lastInputTime;
		public int desiredColumn; // for up/down arrow movement
		...
		public void ClearScroll() => scrollY = 0;

		public void IncrementCursor(bool select = false) => SetCursorIndex(cursorBeforeCharIndex + 1, select);
		public void DecrementCursor(bool select = false) => SetCursorIndex(cursorBeforeCharIndex - 1, select);
	}
}